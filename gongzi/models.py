...
class Gongzi(models.Model):
    ...
    yingfa = models.DecimalField(null=True, max_digits=11, decimal_places=3, blank=True, default=0)
    baoxian = models.DecimalField(null=True, max_digits=11, decimal_places=3, blank=True, default=0)
    gongjijin = models.DecimalField(null=True, max_digits=11, decimal_places=3, blank=True, default=0)
    shuijin = models.DecimalField(null=True, max_digits=11, decimal_places=3, blank=True, default=0)
    shifa = models.DecimalField(null=True, max_digits=11, decimal_places=3, blank=True, default=0)
